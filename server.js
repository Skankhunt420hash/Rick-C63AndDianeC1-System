...
## Delivery target
${product.buildTarget?.label || product.type || "Web App"} - ${product.deliveryLevel || "Product package"}
...
<body>
  ...
  <main>
    <section class="hero">
      ...
      <p class="delivery">${escapeHtml(product.buildTarget?.label || product.type || "Web App")} / ${escapeHtml(product.deliveryLevel || "Product package")}</p>
      <div class="actions">
